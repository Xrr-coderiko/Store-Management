...
const mockSettings: UserSetting[] = [
    { label: "Username",  value: "Vikas",  type: 'text'},
    { label: "Email", value: "vikas55@gmail.com", type: 'text'},
                ...
                <tr className='hover:bg-blue-50' key={setting.label}>
                 ...
                 <td className='py-2 px-4'>
                    {setting.type === 'toggle' ? (
                        ...
                        transition peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] 
